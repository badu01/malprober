...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ results }) => {
  ...
  return (
    <div className="space-y-4" style={{ backgroundColor: '#1f1f1f' }}>
      {/* Header with Verdict */}
          ...
          {expandedSections.activities && (
            <div className="p-4 pt-0">
              ...
              <div className="space-y-3">
                      ...
                      <div key={index} className="p-3 rounded-lg" style={{ backgroundColor: '#1f1f1f' }}>
                        <div className="flex flex-wrap gap-4 text-sm">
                          <div className="flex-1">
                            ...
                            <div className="text-white font-mono text-xs break-all">{item.source_process}</div>
                          </div>
                          <div className="flex-1">
                ...
                {activeTab === 'dns_queries' && logs.dns_queries && (
                  <div className="p-4 text-center text-gray-400">
                    No DNS queries recorded
                  </div>
                )}

                {activeTab === 'processes' && logs.processes && (
                  <div className="p-4 text-center text-gray-400">
                    No processes recorded
                  </div>
                )}

                {activeTab === 'network_activity' && logs.network_activity && (
                  <div className="p-4 text-center text-gray-400">
