 ...
 */
ipcMain.handle('analysis:upload-file', async (_event, filePath: string) => {
    try {
...
ipcMain.handle('static_analysis', async (_event, filePath: string) => {
    try {
 ...
 */
ipcMain.handle('analysis:start', async (_event, filePath: string) => {
    try {
 ...
 */
ipcMain.handle('analysis:status', async (_event, analysisId: string) => {
    try {
 ...
 */
ipcMain.handle('analysis:results', async (_event, analysisId: string) => {
    try {
